...
* @version: $Revision$
* @date: Monday, December 30, 2024-6:08:23 PM
* BCF Version - 1.0.0
...
//Version is (0x01) on this line "0xAD, 0x01, 0x10, 0x28, 0x18, (0x01), 0x50, 0x00,". If you have to use version 0, you need to change (0x00).
 static a2b_Byte  gA2bNetworkChain0[]  = {
...
0xAD, 0x01, 0x10, 0x28, 0x18, 0x01, 0x50, 0x00, 
