...
/*============= I N C L U D E S =============*/
#include "main_conf.h" //ESTEC_A2B_STACK_PORTING
/*============= D E F I N E S =============*/
...
/* Compressed BCF */
#define ADI_A2B_BCF_COMPRESSED //KMS241202_3 : To reduce RAM size, we need to use A2B BCF COMPRESSED.

/* Interrupt Mode */
/*#define ENABLE_INTERRUPT_PROCESS */ //ESTEC_A2B_STACK_PORTING
