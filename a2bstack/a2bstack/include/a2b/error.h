...
typedef enum {
    /** 0: No error - operation a success */
    A2B_EC_OK = (a2b_UInt32)0u,

    /** 1: Invalid parameter or bad argument */
    A2B_EC_INVALID_PARAMETER,

    /** 2: Resource could not be allocated */
    A2B_EC_ALLOC_FAILURE,

    /** 3: Failure decoding network configuration */
    A2B_EC_NETWORK_DECODE_FAILURE,

    /** 4: Invalid state for request */
    ...
    /** 8: I2C slave address NACK error */
    A2B_EC_I2C_ADDR_NACK,

    /** 9: I2C slave data NACK error */
    A2B_EC_I2C_DATA_NACK,

    /** 10: I2C arbitration lost error */
    A2B_EC_I2C_ARBL,

    /**
     * 11: I2C bus locked. Likely due to clock line of bus being held low by some
     * other device.
     */
    A2B_EC_I2C_BUS_LOCKED,

    /** 12: Some form of I/O error */
    A2B_EC_IO,

    /** 13: Catch-all error condition */
    A2B_EC_INTERNAL,

    /** 14: Resource currently unavailable */
    A2B_EC_RESOURCE_UNAVAIL,

    /** 15: A2B power diagnostics failure */
    A2B_EC_POWER_DIAG_FAILURE,

    /** 16: General A2B discovery failure */
    A2B_EC_DISCOVERY_FAILURE,

    /** 17: A2B discovery failure due to power fault error */
    A2B_EC_DISCOVERY_PWR_FAULT,

    /** 18: An operation was cancelled */
    A2B_EC_CANCELLED,

	/** 19: Custom Node Id Authentication failure */
    A2B_EC_CUSTOM_NODE_ID_AUTH,

	/** 20: Custom Node Id Authentication Timeout
	 * when using communication channel
	 * */
	A2B_EC_CUSTOM_NODE_ID_TIMEOUT,

	/** 21: Transceiver authentication
