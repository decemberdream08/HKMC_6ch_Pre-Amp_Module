...
/*======================= I N C L U D E S =========================*/
#include "..\..\..\main_conf.h" //KMS241108_1 : To fix error & warning upon proting A2B stack
 ...
 */
#ifndef ESTECT_A2B_ENABLE
//#define A2B_FEATURE_64_BIT_INTEGER //KMS241108_1 : To fix error & warning upon proting A2B stack
#endif
 ...
 */
/* #define A2B_FEATURE_EEPROM_OR_FILE_PROCESSING*/ //#error "A2B_BCF_FROM_SOC_EEPROM & ADI_SIGMASTUDIO_BCF features are mutually exclusive. Define only one to proceed further"
 ...
 *  (connected to Target )
 */
 /* #define A2B_BCF_FROM_FILE_IO */ //KMS241203_1 : This define is not used with ADI_SIGMASTUDIO_BCF at once.
