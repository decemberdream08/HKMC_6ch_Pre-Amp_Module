...
void ADAU1452_Download_Init_Value(void)
{
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xC000, 3040, (uint8_t *)MODE_1_71);			/* Program Data */
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0x0000, 792, (uint8_t *)MODE_1_72);			/* DM0 Data */
