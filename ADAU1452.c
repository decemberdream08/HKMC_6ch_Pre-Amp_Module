...
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF21D, 2, (uint8_t *)MODE_1_69);			/* IC 1.SERIAL_BYTE_7_1 */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF604, 2, (uint8_t *)MODE_1_70);			/* IC 1.SPDIF_RESTART */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF690, 2, (uint8_t *)MODE_1_71);			/* IC 1.SPDIF_TX_EN */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xC000, 620, (uint8_t *)MODE_1_72);			/* Program Data */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0x0000, 172, (uint8_t *)MODE_1_73);			/* DM0 Data */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0x6010, 16, (uint8_t *)MODE_1_74);			/* DM1 Data */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF403, 2, (uint8_t *)MODE_1_75);			/* IC 1.KILL_CORE */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF404, 2, (uint8_t *)MODE_1_76);			/* IC 1.START_ADDRESS */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF401, 2, (uint8_t *)MODE_1_77);			/* IC 1.START_PULSE */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF402, 2, (uint8_t *)MODE_1_78);			/* IC 1.START_CORE */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF402, 2, (uint8_t *)MODE_1_79);			/* IC 1.START_CORE */
delay_ms(20);			/* IC 1.Start Delay */
SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xF400, 2, (uint8_t *)MODE_1_81);			/* IC 1.HIBERNATE */
}
