...
void ADAU1452_Download_Init_Value(void)
{
	...
	//KMS250425_1
	//KMS250428_2
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0xC000, 3588, (uint8_t *)MODE_1_71);			/* Program Data */
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0x0000, 936, (uint8_t *)MODE_1_72);			/* DM0 Data */
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_ADAU1452, 0x60B0, 276, (uint8_t *)MODE_1_73);			/* DM1 Data */
