...
#define SPI_CPHA_LO                 ((uint32_t)(0))      /**< SPI clock phase is Active-Low  */
#define SPI_CPHA_HI                 ((uint32_t)(1))      /**< SPI clock phase is Active-High  */

#define SPI_CPOL_LO                 ((uint32_t)(0))      /**< SPI clock Polarity is Active-Low  */
#define SPI_CPOL_HI                 ((uint32_t)(1))      /**< SPI clock Polarity is Active-High  */
